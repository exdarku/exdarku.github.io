...
import AidvocatePicture1 from './assets/aidvocate/landing-page.png'
import AidvocatePicture2 from './assets/aidvocate/charities.png'
import AidvocatePicture3 from './assets/aidvocate/event-page.png'
import AidvocatePicture4 from './assets/aidvocate/admin-page.png'
import BaganiPicture1 from './assets/bagani/landing.png';
import BaganiPicture2 from './assets/bagani/landing-2.png';
import BaganiPicture3 from './assets/bagani/registration.png';
import BaganiPicture4 from './assets/bagani/registration-2.png';
import KryptoPicture1 from './assets/krypto/login.jpeg';
import KryptoPicture2 from './assets/krypto/mainmenu.jpeg';
import KryptoPicture3 from './assets/krypto/mainmenu_withaccount.jpeg';
import KryptoPicture4 from './assets/krypto/account.jpeg';
import OCPPicture1 from './assets/project-ocp/landing.png';
import OCPPicture2 from './assets/project-ocp/industry-partners.png';
import OCPPicture3 from './assets/project-ocp/events.png';
import OrbitPicture1 from './assets/lumina-orbit/landing.png';
import OrbitPicture2 from './assets/lumina-orbit/login.png';
import OrbitPicture3 from './assets/lumina-orbit/dashboard.png';
import OrbitPicture4 from './assets/lumina-orbit/projects.png';
import OrbitPicture5 from './assets/lumina-orbit/billing.png';
...
const App = () => {
  ...
  const projects = [
    {
      id: 1,
      title: 'Lumina Tech Orbit',
      description: 'A comprehensive platform that combines administrative management and DevOps monitoring, allowing teams to track server usage, manage employee operations, and oversee critical business functions—all within a single, unified system.',
      fullDescription: "Lumina Tech Orbit is an all-in-one administrative and operations monitoring system developed by Lumina Tech. It enables employees to oversee server usage across client environments, ensuring timely responses and efficient infrastructure management. The platform also serves as the company's central administrative hub, handling payroll, financial records, and other essential business functions. Built with React, Node.js, Express, MySQL, Docker, and hosted on AWS EC2, Lumina Tech Orbit combines powerful DevOps capabilities with streamlined administrative tools.",
      images: [
        OrbitPicture1, OrbitPicture2, OrbitPicture3, OrbitPicture4, OrbitPicture5
      ],
      date: '2025',
      technologies: ["React", "Node.js", "Express.js", "MySQL", "Docker", "Amazon Web Service EC2"],
      github: null,
      demo: null,
    ...
    },
    {
      ...
      images: [
        BaganiPicture1, BaganiPicture2, BaganiPicture3, BaganiPicture4
      ],
      date: '2025',
    ...
    },
    {
      ...
      date: '2024',
      technologies: ['React', 'Node.js', 'MySQL', 'Express.js', 'Docker', 'Amazon Web Services (AWS) EC2'],
    ...
    },
    {
      ...
      images: [
        KryptoPicture1, KryptoPicture2, KryptoPicture3, KryptoPicture4
      ],
      date: '2024',
      technologies: ['Python', 'PyQt5', 'Firebase', 'Cryptography (AES 256)'],
    ...
    },
    {
      ...
      images: [
        OCPPicture1, OCPPicture2, OCPPicture3
      ],
      date: '2024',
      technologies: ["MySQL", "Node.js", "Express.js", "Knex.js"],
      github: null,
      demo: null,
      gradient: 'from-yellow-400 via-orange-500 to-yellow-600'
    },
